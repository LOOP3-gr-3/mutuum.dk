...
require_once('includes/kontraktdatabase.php');
...
<div class="container">
    ...
    <div id="netveark" class="collapse">
        ...
        <div class="btn btn-light dropdown-toggle">
            <select class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <?php  /* Dette henter værdierne fra vores tabel "beloeb" fra vores server ind til denne dropdown */  
                if ($rowsbeloeb > 0) {
                    echo "<option value='--'>Angiv beløb i DKK</option>";                
                    while($rowbeloeb = mysqli_fetch_assoc($resultbeloeb)) {
                    echo "<option value='" . $rowbeloeb['beloeb_id'] . "'>" . $rowbeloeb['beloeb'] . "</option>";
                    } 
                } 
                mysqli_close($con);
                ?>
...
<div class="container">
    ...
    <button type="button" class="btn btn-secondary" data-toggle="collapse" data-target="#matchside" id="xmatchside" onclick="toggleMatch()">Låneftale til vilkårlig</button>
...
?>-->
<script>
    function toggleNetvaerk(netvaerk, match) {
        var netvaerk = 1;
        var match = 0;
    }

    function toggleMatch(netvaerk, match) {
        var match = 2;
        var netvaerk = 0;
    }
